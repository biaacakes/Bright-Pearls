            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <p class="promo-description">
                        Your journey to a confident smile starts here. sheeeeeeesh
                    </p>
    ...
    $("#login_submit").on("click", function() {
        ...
        e > 1 ? "" != t.trim() && /^[A-Z0-9._%+-]+@([A-Z0-9-]+\.)+[A-Z]{2,4}$/i.test(t) ? "" == s
            .trim() ? (console.log("Password Field is Empty"), $(".statusMsg").html(
                ...
                success: function(t) {
                    t = t.substr(t.lastIndexOf(".") + 1), console.log(t), "admin" === t ? (e =
                        5, window.location.href = "dashboard.php") : "error" === t ? (e--,
                        console.log("Atempts left: " + e), alert("Login Attempts Left: " +
                            e), $(".statusMsg").html(
                            "<span style='color:red;'>Invalid Credentials</p>")) : (e = 5,
                        console.log("User login"), window.location.href =
                        "patientDashboard.php")
                }
            }) : (console.log("Invalid Email"), $(".statusMsg").html(
                    '<span style="color:red;">Invalid Email</p>'), document.getElementById("username")
                .value = "") : ($(".statusMsg").html(
                    "<span style='color:red;'>Login limit reached. Please wait for 30 seconds.</p>"),
                document.getElementById("login_submit").style.visibility = "hidden", document
                .getElementById("username").disabled = !0, document.getElementById("password")
                .disabled = !0, setTimeout(function() {
                    document.getElementById("username").disabled = !1, document.getElementById(
                            "password").disabled = !1, document.getElementById("login_submit").style
                        .visibility = "visible", e = 5
                }, 3e4))
    })
});
</script>
